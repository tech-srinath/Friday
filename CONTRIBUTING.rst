...
Friday could always use more documentation, whether as part of the
official Friday docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7, 3.3, 3.4, 3.5, and 3.6. Check
   https://travis-ci.org/Zenohm/friday/pull_requests
